...
from retrievers.classes.clip import ClipRetriever
from retrievers.classes.biqwen2_5 import BiQwen2_5Retriever
...
def setup_paths_and_results(chunks_path, resize_ratio=0.5):
    ...
    results_path = f"{results_dir}/vision_retrievers_results_{chunks_filename}.json"
    txt_results_path = f"{results_dir}/vision_retrievers_results_{chunks_filename}.txt"
