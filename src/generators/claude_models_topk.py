...
Question: {question}"""
            ...
            # Build content array with all images first, then text prompt
    ...
    def generate_answers(self, models, limit=None, output_dir="src/generators/results/retrieval_pipeline"):
        ...
        for model, model_results in results_by_model.items():
            ...
            output_file = f"{output_dir}/claude_top-k_{model_safe}.json"
...
def main():
    ...
    args.is_test = True 
    if not args.models:
        args.models = ['claude-3-haiku-20240307', 'claude-sonnet-4-20250514']
    ...
    for top_k in args.top_k:
        ...
        for retriever in args.retrievers:
            ...
            generator = ClaudeTopKGenerator(data_file, args.annotations_file, models=args.models, top_k=top_k)
