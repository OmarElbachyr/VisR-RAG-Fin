...
with open('/home/laura/vqa-ir-qa/data/sorted_scores_colnomic.json', 'r') as f:
...
with open("/home/laura/vqa-ir-qa/data/colnomic_gemma4b_output_topk1.json", "w", encoding="utf-8") as f:
