...
with open('/home/laura/vqa-ir-qa/data/retrieved_pages/vidore_colpali-v1.3_sorted_run.json', 'r') as f:
...
repo = "OpenGVLab/InternVL3-2B-hf"
...
for item in query_inputs:
    ...
    try:
        ...
        with open("/home/laura/vqa-ir-qa/data/colipali_qwen25_answers_annotated.json", "a", encoding="utf-8") as out:
            json.dump({
                "question": query,
        ...
        with open("/home/laura/vqa-ir-qa/data/failed_colipali_qwen25_cases_annotated.txt", "a", encoding="utf-8") as err:
