...
#                    model_name="BAAI/bge-m3", device_map='cuda', txt_file_path=txt_results_path)
    
#     test_retriever(SentenceTransformerRetriever, provider, queries, qrels, results["models"], agg="max", 
#                    model_name="intfloat/multilingual-e5-large", is_instruct=False, device_map='cuda', txt_file_path=txt_results_path)
    
#     test_retriever(SentenceTransformerRetriever, provider, queries, qrels, results["models"], agg="max", 
#                    model_name="intfloat/multilingual-e5-large-instruct", is_instruct=True, device_map='cuda', txt_file_path=txt_results_path)
