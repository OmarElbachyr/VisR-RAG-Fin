...
if __name__ == "__main__":
    ...
    results_path = f"src/results/colvision_retrievers_results_{data_option}.json"
    txt_results_path = f"src/results/colvision_retrievers_results_{data_option}.txt"
    ...
    test_retriever(
        ...
        model_name="vidore/colqwen2.5-v0.2", image_dir=image_dir, txt_file_path=txt_results_path, batch_size=16, device_map="cuda"
    )
    test_retriever(
        ColQwen2_5Retriever, provider, queries, qrels, results["models"],
